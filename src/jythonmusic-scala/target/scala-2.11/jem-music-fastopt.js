...
/** @constructor */
function $c_Ljythonmusic_MidiPlayer$() {
  $c_O.call(this);
  this.jythonmusic$MidiPlayer$$midiTracks$1 = null;
  this.startTime$1 = 0.0
}
$c_Ljythonmusic_MidiPlayer$.prototype = new $h_O();
$c_Ljythonmusic_MidiPlayer$.prototype.constructor = $c_Ljythonmusic_MidiPlayer$;
/** @constructor */
function $h_Ljythonmusic_MidiPlayer$() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiPlayer$.prototype = $c_Ljythonmusic_MidiPlayer$.prototype;
$c_Ljythonmusic_MidiPlayer$.prototype.init___ = (function() {
  $n_Ljythonmusic_MidiPlayer$ = this;
  this.jythonmusic$MidiPlayer$$midiTracks$1 = $as_scm_ArrayBuffer($m_scm_ArrayBuffer$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  this.startTime$1 = 0.0;
  return this
});
$c_Ljythonmusic_MidiPlayer$.prototype.playTracks__D__V = (function(delay) {
  var startDelay = ((this.startTime$1 > 0.0) ? (($uD($g.Date.now()) - this.startTime$1) / 1000) : 0.0);
  var this$1 = this.jythonmusic$MidiPlayer$$midiTracks$1;
  var i = 0;
  var top = this$1.size0$6;
  while ((i < top)) {
    var arg1 = this$1.array$6.u[i];
    var track = $as_Ljythonmusic_MidiTrack(arg1);
    if ((track.associated$undchannel$1 >= 0)) {
      track.writeToChannel__I__D__V(track.associated$undchannel$1, (startDelay + delay))
    };
    i = ((1 + i) | 0)
  }
});
$c_Ljythonmusic_MidiPlayer$.prototype.initialize__V = (function() {
  this.startTime$1 = $uD($g.Date.now())
});
$c_Ljythonmusic_MidiPlayer$.prototype.tracksLoaded__Z = (function() {
  ...
  try {
    ...
    while ((i < top)) {
      var arg1 = this$1.array$6.u[i];
      var track = $as_Ljythonmusic_MidiTrack(arg1);
      if ((!track.jythonmusic$MidiTrack$$instrumentLoaded$1)) {
...
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$loadAndPlayTracks__sjs_js_Array__O = (function(tracks) {
  this.loadAndPlayTracks__sjs_js_Array__V(tracks)
});
$c_Ljythonmusic_MidiPlayer$.prototype.loadAndPlayTracks__sjs_js_Array__V = (function(tracks) {
  var elem = $uI(tracks.length);
  var loadingCount = new $c_sr_IntRef().init___I(elem);
  this.clearTracks__V();
  var f = new $c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1().init___sr_IntRef(loadingCount);
  var i = 0;
  var len = $uI(tracks.length);
  while ((i < len)) {
    var index = i;
    var v1 = tracks[index];
    f.apply__Ljythonmusic_MidiTrack__V($as_Ljythonmusic_MidiTrack(v1));
    i = ((1 + i) | 0)
  }
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$initialize__O = (function() {
  this.initialize__V()
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$clearTracks__O = (function() {
  this.clearTracks__V()
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$tracksLoaded__O = (function() {
  return this.tracksLoaded__Z()
});
$c_Ljythonmusic_MidiPlayer$.prototype.clearTracks__V = (function() {
  var this$1 = this.jythonmusic$MidiPlayer$$midiTracks$1;
  var i = 0;
  var top = this$1.size0$6;
  while ((i < top)) {
    var arg1 = this$1.array$6.u[i];
    var track = $as_Ljythonmusic_MidiTrack(arg1);
    track.associated$undchannel$1 = (-1);
    i = ((1 + i) | 0)
  };
  var this$2 = this.jythonmusic$MidiPlayer$$midiTracks$1;
  $s_scm_ResizableArray$class__reduceToSize__scm_ResizableArray__I__V(this$2, 0)
});
$c_Ljythonmusic_MidiPlayer$.prototype.addTrack__Ljythonmusic_MidiTrack__V = (function(track) {
  if ((track !== null)) {
    var this$1 = this.jythonmusic$MidiPlayer$$midiTracks$1;
    var jsx$1 = (this$1.size0$6 < 9)
  } else {
    var jsx$1 = false
  };
  if (jsx$1) {
    var this$2 = this.jythonmusic$MidiPlayer$$midiTracks$1;
    var channel = this$2.size0$6;
    track.associated$undchannel$1 = channel;
    track.loadInstrument__I__V(channel);
    this.jythonmusic$MidiPlayer$$midiTracks$1.$$plus$eq__O__scm_ArrayBuffer(track)
  }
});
$c_Ljythonmusic_MidiPlayer$.prototype.stop__V = (function() {
  $g.MIDI.stopAllNotes()
});
$c_Ljythonmusic_MidiPlayer$.prototype.jythonmusic$MidiPlayer$$trackLoaded$1__sr_IntRef__V = (function(loadingCount$1) {
  loadingCount$1.elem$1 = (((-1) + loadingCount$1.elem$1) | 0);
  if ((loadingCount$1.elem$1 === 0)) {
    this.playTracks__D__V(0.01)
  }
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$addTrack__Ljythonmusic_MidiTrack__O = (function(track) {
  this.addTrack__Ljythonmusic_MidiTrack__V(track)
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$stop__O = (function() {
  this.stop__V()
});
$c_Ljythonmusic_MidiPlayer$.prototype.$$js$exported$meth$playTracks__D__O = (function(delay) {
  this.playTracks__D__V(delay)
});
$c_Ljythonmusic_MidiPlayer$.prototype.loadAndPlayTracks = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$loadAndPlayTracks__sjs_js_Array__O(prep0)
});
$c_Ljythonmusic_MidiPlayer$.prototype.playTracks = (function(arg$1) {
  var prep0 = $uD(arg$1);
  return this.$$js$exported$meth$playTracks__D__O(prep0)
});
$c_Ljythonmusic_MidiPlayer$.prototype.stop = (function() {
  return this.$$js$exported$meth$stop__O()
});
$c_Ljythonmusic_MidiPlayer$.prototype.tracksLoaded = (function() {
  return this.$$js$exported$meth$tracksLoaded__O()
});
$c_Ljythonmusic_MidiPlayer$.prototype.clearTracks = (function() {
  return this.$$js$exported$meth$clearTracks__O()
});
$c_Ljythonmusic_MidiPlayer$.prototype.addTrack = (function(arg$1) {
  var prep0 = $as_Ljythonmusic_MidiTrack(arg$1);
  return this.$$js$exported$meth$addTrack__Ljythonmusic_MidiTrack__O(prep0)
});
$c_Ljythonmusic_MidiPlayer$.prototype.initialize = (function() {
  return this.$$js$exported$meth$initialize__O()
});
var $d_Ljythonmusic_MidiPlayer$ = new $TypeData().initClass({
  Ljythonmusic_MidiPlayer$: 0
}, false, "jythonmusic.MidiPlayer$", {
  Ljythonmusic_MidiPlayer$: 1,
  O: 1
});
$c_Ljythonmusic_MidiPlayer$.prototype.$classData = $d_Ljythonmusic_MidiPlayer$;
var $n_Ljythonmusic_MidiPlayer$ = (void 0);
function $m_Ljythonmusic_MidiPlayer$() {
  if ((!$n_Ljythonmusic_MidiPlayer$)) {
    $n_Ljythonmusic_MidiPlayer$ = new $c_Ljythonmusic_MidiPlayer$().init___()
  };
  return $n_Ljythonmusic_MidiPlayer$
}
$e.jythonmusic = ($e.jythonmusic || {});
$e.jythonmusic.MidiPlayer = $m_Ljythonmusic_MidiPlayer$;
/** @constructor */
function $c_Ljythonmusic_MidiPluginParameter$() {
  $c_O.call(this)
}
$c_Ljythonmusic_MidiPluginParameter$.prototype = new $h_O();
$c_Ljythonmusic_MidiPluginParameter$.prototype.constructor = $c_Ljythonmusic_MidiPluginParameter$;
/** @constructor */
function $h_Ljythonmusic_MidiPluginParameter$() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiPluginParameter$.prototype = $c_Ljythonmusic_MidiPluginParameter$.prototype;
$c_Ljythonmusic_MidiPluginParameter$.prototype.init___ = (function() {
  return this
});
$c_Ljythonmusic_MidiPluginParameter$.prototype.apply__T__T__sjs_js_Function0__Ljythonmusic_MidiPluginParameter = (function(soundfontUrl, instrument, onsuccess) {
  return {
...
var $d_Ljythonmusic_MidiPluginParameter$ = new $TypeData().initClass({
  Ljythonmusic_MidiPluginParameter$: 0
}, false, "jythonmusic.MidiPluginParameter$", {
  Ljythonmusic_MidiPluginParameter$: 1,
  O: 1
});
$c_Ljythonmusic_MidiPluginParameter$.prototype.$classData = $d_Ljythonmusic_MidiPluginParameter$;
var $n_Ljythonmusic_MidiPluginParameter$ = (void 0);
function $m_Ljythonmusic_MidiPluginParameter$() {
  if ((!$n_Ljythonmusic_MidiPluginParameter$)) {
    $n_Ljythonmusic_MidiPluginParameter$ = new $c_Ljythonmusic_MidiPluginParameter$().init___()
  };
  return $n_Ljythonmusic_MidiPluginParameter$
}
/** @constructor */
function $c_Ljythonmusic_MidiTrack() {
  $c_O.call(this);
  this.associated$undchannel$1 = 0;
  this.instrument$1 = null;
  this.jythonmusic$MidiTrack$$instrumentLoaded$1 = false;
  this.jythonmusic$MidiTrack$$instrumentNumber$1 = 0;
  this.noteBuffer$1 = null;
  this.volume$1 = 0
}
$c_Ljythonmusic_MidiTrack.prototype = new $h_O();
$c_Ljythonmusic_MidiTrack.prototype.constructor = $c_Ljythonmusic_MidiTrack;
/** @constructor */
function $h_Ljythonmusic_MidiTrack() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiTrack.prototype = $c_Ljythonmusic_MidiTrack.prototype;
$c_Ljythonmusic_MidiTrack.prototype.addNote__I__I__D__V = (function(note, velocity, duration) {
  this.noteBuffer$1.$$plus$eq__O__scm_ArrayBuffer(new $c_Ljythonmusic_MidiTrack$Note().init___I__I__D(note, velocity, duration))
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$prop$volume__O = (function() {
  return this.volume$1
});
$c_Ljythonmusic_MidiTrack.prototype.init___ = (function() {
  this.associated$undchannel$1 = (-1);
  this.instrument$1 = "acoustic_grand_piano";
  this.jythonmusic$MidiTrack$$instrumentLoaded$1 = false;
  this.jythonmusic$MidiTrack$$instrumentNumber$1 = 0;
  this.noteBuffer$1 = $as_scm_ArrayBuffer($m_scm_ArrayBuffer$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  this.volume$1 = 127;
  return this
});
$c_Ljythonmusic_MidiTrack.prototype.loadInstrumentAndCall__I__F0__V = (function(channel, feedback) {
  var jsx$1 = $g.MIDI;
  var this$1 = $m_Ljythonmusic_MidiPluginParameter$();
  var instrument = this.instrument$1;
  var onsuccess = (function(arg$outer, channel$3, feedback$1) {
    return (function() {
      $g.MIDI.programChange(channel$3, arg$outer.jythonmusic$MidiTrack$$instrumentNumber$1);
      $g.MIDI.setVolume(channel$3, arg$outer.volume$1);
      arg$outer.jythonmusic$MidiTrack$$instrumentLoaded$1 = true;
      feedback$1.apply__O()
    })
  })(this, channel, feedback);
  jsx$1.loadPlugin(this$1.apply__T__T__sjs_js_Function0__Ljythonmusic_MidiPluginParameter("./soundfont/", instrument, onsuccess))
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$loadInstrument__I__O = (function(channel) {
  this.loadInstrument__I__V(channel)
});
$c_Ljythonmusic_MidiTrack.prototype.loadInstrument__I__V = (function(channel) {
  var jsx$1 = $g.MIDI;
  var this$1 = $m_Ljythonmusic_MidiPluginParameter$();
  var instrument = this.instrument$1;
  var onsuccess = (function(arg$outer, channel$1) {
    return (function() {
      $g.MIDI.programChange(channel$1, arg$outer.jythonmusic$MidiTrack$$instrumentNumber$1);
      $g.MIDI.setVolume(channel$1, arg$outer.volume$1);
      arg$outer.jythonmusic$MidiTrack$$instrumentLoaded$1 = true
    })
  })(this, channel);
  jsx$1.loadPlugin(this$1.apply__T__T__sjs_js_Function0__Ljythonmusic_MidiPluginParameter("./soundfont/", instrument, onsuccess))
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$writeToChannel__I__D__O = (function(channel, startDelay) {
  this.writeToChannel__I__D__V(channel, startDelay)
});
$c_Ljythonmusic_MidiTrack.prototype.normalizeInstrumentName__p1__T__T = (function(name) {
  var thiz = $as_T(name.toLowerCase());
  var target = $as_T($g.String.fromCharCode(45));
  var replacement = $as_T($g.String.fromCharCode(95));
  var thiz$1 = $as_T(thiz.split(target).join(replacement));
  var target$1 = $as_T($g.String.fromCharCode(32));
  var replacement$1 = $as_T($g.String.fromCharCode(95));
  var thiz$2 = $as_T(thiz$1.split(target$1).join(replacement$1));
  return $as_T(thiz$2.split("__").join("_"))
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$setInstrument__T__O = (function(instrumentName) {
  this.setInstrument__T__V(instrumentName)
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$prop$volume__I__O = (function(x$1) {
  this.volume$1 = x$1
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$addChord__sjs_js_Array__I__D__O = (function(chord, velocity, duration) {
  this.addChord__sjs_js_Array__I__D__V(chord, velocity, duration)
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$addNote__I__I__D__O = (function(note, velocity, duration) {
  this.addNote__I__I__D__V(note, velocity, duration)
});
$c_Ljythonmusic_MidiTrack.prototype.writeToChannel__I__D__V = (function(channel, startDelay) {
  if (((channel >= 0) && (channel < 16))) {
    var this$1 = this.noteBuffer$1;
    var jsx$1 = $s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$1)
  } else {
    var jsx$1 = false
  };
  if (jsx$1) {
    var elem$1 = 0.0;
    elem$1 = startDelay;
    var this$3 = this.noteBuffer$1;
    var i = 0;
    var top = this$3.size0$6;
    while ((i < top)) {
      var arg1 = this$3.array$6.u[i];
      var noteItem = $as_Ljythonmusic_MidiTrack$NoteItem(arg1);
      if ($is_Ljythonmusic_MidiTrack$Chord(noteItem)) {
        var x2 = $as_Ljythonmusic_MidiTrack$Chord(noteItem);
        var notes = x2.notes$2;
        var velocity = x2.velocity$2;
        var duration = x2.duration$2;
        $g.MIDI.chordOn(channel, notes, velocity, elem$1);
        $g.MIDI.chordOff(channel, notes, (elem$1 + duration));
        elem$1 = (elem$1 + duration)
      } else if ($is_Ljythonmusic_MidiTrack$Note(noteItem)) {
        var x3 = $as_Ljythonmusic_MidiTrack$Note(noteItem);
        var note = x3.note$2;
        var velocity$2 = x3.velocity$2;
        var duration$2 = x3.duration$2;
        $g.MIDI.noteOn(channel, note, velocity$2, elem$1);
        $g.MIDI.noteOff(channel, note, (elem$1 + duration$2));
        elem$1 = (elem$1 + duration$2)
      } else if ($is_Ljythonmusic_MidiTrack$Rest(noteItem)) {
        var x4 = $as_Ljythonmusic_MidiTrack$Rest(noteItem);
        var duration$3 = x4.duration$2;
        elem$1 = (elem$1 + duration$3)
      } else {
        throw new $c_s_MatchError().init___O(noteItem)
      };
      i = ((1 + i) | 0)
    }
  }
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$prop$getInstrumentNumber__O = (function() {
  return this.jythonmusic$MidiTrack$$instrumentNumber$1
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$meth$addRest__D__O = (function(duration) {
  this.addRest__D__V(duration)
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$prop$getInstrument__O = (function() {
  return this.instrument$1
});
$c_Ljythonmusic_MidiTrack.prototype.$$js$exported$prop$isInstrumentLoaded__O = (function() {
  return this.jythonmusic$MidiTrack$$instrumentLoaded$1
});
$c_Ljythonmusic_MidiTrack.prototype.addChord__sjs_js_Array__I__D__V = (function(chord, velocity, duration) {
  this.noteBuffer$1.$$plus$eq__O__scm_ArrayBuffer(new $c_Ljythonmusic_MidiTrack$Chord().init___sjs_js_Array__I__D(chord, velocity, duration))
});
$c_Ljythonmusic_MidiTrack.prototype.setInstrument__T__V = (function(instrumentName) {
  this.instrument$1 = this.normalizeInstrumentName__p1__T__T(instrumentName);
  this.jythonmusic$MidiTrack$$instrumentNumber$1 = $uI($g.MIDI.GM.byName[this.instrument$1].number);
  this.jythonmusic$MidiTrack$$instrumentLoaded$1 = false;
  if ((this.associated$undchannel$1 >= 0)) {
    this.loadInstrument__I__V(this.associated$undchannel$1)
  }
});
$c_Ljythonmusic_MidiTrack.prototype.addRest__D__V = (function(duration) {
  this.noteBuffer$1.$$plus$eq__O__scm_ArrayBuffer(new $c_Ljythonmusic_MidiTrack$Rest().init___D(duration))
});
$c_Ljythonmusic_MidiTrack.prototype.writeToChannel = (function(arg$1, arg$2) {
  var prep0 = $uI(arg$1);
  var prep1 = $uD(arg$2);
  return this.$$js$exported$meth$writeToChannel__I__D__O(prep0, prep1)
});
$c_Ljythonmusic_MidiTrack.prototype.addRest = (function(arg$1) {
  var prep0 = $uD(arg$1);
  return this.$$js$exported$meth$addRest__D__O(prep0)
});
$c_Ljythonmusic_MidiTrack.prototype.addNote = (function(arg$1, arg$2, arg$3) {
  var prep0 = $uI(arg$1);
  var prep1 = $uI(arg$2);
  var prep2 = $uD(arg$3);
  return this.$$js$exported$meth$addNote__I__I__D__O(prep0, prep1, prep2)
});
$c_Ljythonmusic_MidiTrack.prototype.addChord = (function(arg$1, arg$2, arg$3) {
  var prep0 = arg$1;
  var prep1 = $uI(arg$2);
  var prep2 = $uD(arg$3);
  return this.$$js$exported$meth$addChord__sjs_js_Array__I__D__O(prep0, prep1, prep2)
});
$c_Ljythonmusic_MidiTrack.prototype.loadInstrument = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$loadInstrument__I__O(prep0)
});
Object.defineProperty($c_Ljythonmusic_MidiTrack.prototype, "isInstrumentLoaded", {
  "get": (function() {
    return this.$$js$exported$prop$isInstrumentLoaded__O()
  }),
  "enumerable": true
});
$c_Ljythonmusic_MidiTrack.prototype.setInstrument = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$setInstrument__T__O(prep0)
});
Object.defineProperty($c_Ljythonmusic_MidiTrack.prototype, "getInstrumentNumber", {
  "get": (function() {
    return this.$$js$exported$prop$getInstrumentNumber__O()
  }),
  "enumerable": true
});
Object.defineProperty($c_Ljythonmusic_MidiTrack.prototype, "getInstrument", {
  "get": (function() {
    return this.$$js$exported$prop$getInstrument__O()
  }),
  "enumerable": true
});
Object.defineProperty($c_Ljythonmusic_MidiTrack.prototype, "volume", {
  "set": (function(arg$1) {
    var prep0 = $uI(arg$1);
    this.$$js$exported$prop$volume__I__O(prep0)
  }),
  "get": (function() {
    return this.$$js$exported$prop$volume__O()
  }),
  "enumerable": true
});
function $is_Ljythonmusic_MidiTrack(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljythonmusic_MidiTrack)))
}
function $as_Ljythonmusic_MidiTrack(obj) {
  return (($is_Ljythonmusic_MidiTrack(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "jythonmusic.MidiTrack"))
}
function $isArrayOf_Ljythonmusic_MidiTrack(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljythonmusic_MidiTrack)))
}
function $asArrayOf_Ljythonmusic_MidiTrack(obj, depth) {
  return (($isArrayOf_Ljythonmusic_MidiTrack(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljythonmusic.MidiTrack;", depth))
}
var $d_Ljythonmusic_MidiTrack = new $TypeData().initClass({
  Ljythonmusic_MidiTrack: 0
}, false, "jythonmusic.MidiTrack", {
  Ljythonmusic_MidiTrack: 1,
  O: 1
});
$c_Ljythonmusic_MidiTrack.prototype.$classData = $d_Ljythonmusic_MidiTrack;
$e.jythonmusic = ($e.jythonmusic || {});
/** @constructor */
$e.jythonmusic.MidiTrack = (function() {
  var $thiz = new $c_Ljythonmusic_MidiTrack();
  $c_Ljythonmusic_MidiTrack.prototype.init___.call($thiz);
  return $thiz
});
$e.jythonmusic.MidiTrack.prototype = $c_Ljythonmusic_MidiTrack.prototype;
/** @constructor */
function $c_Ljythonmusic_MidiTrack$NoteItem() {
  $c_O.call(this)
}
$c_Ljythonmusic_MidiTrack$NoteItem.prototype = new $h_O();
$c_Ljythonmusic_MidiTrack$NoteItem.prototype.constructor = $c_Ljythonmusic_MidiTrack$NoteItem;
/** @constructor */
function $h_Ljythonmusic_MidiTrack$NoteItem() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiTrack$NoteItem.prototype = $c_Ljythonmusic_MidiTrack$NoteItem.prototype;
function $is_Ljythonmusic_MidiTrack$NoteItem(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljythonmusic_MidiTrack$NoteItem)))
}
function $as_Ljythonmusic_MidiTrack$NoteItem(obj) {
  return (($is_Ljythonmusic_MidiTrack$NoteItem(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "jythonmusic.MidiTrack$NoteItem"))
}
function $isArrayOf_Ljythonmusic_MidiTrack$NoteItem(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljythonmusic_MidiTrack$NoteItem)))
}
function $asArrayOf_Ljythonmusic_MidiTrack$NoteItem(obj, depth) {
  return (($isArrayOf_Ljythonmusic_MidiTrack$NoteItem(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljythonmusic.MidiTrack$NoteItem;", depth))
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1() {
  $c_sr_AbstractFunction1.call(this);
  this.loadingCount$1$f = null
}
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype = new $h_sr_AbstractFunction1();
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype.constructor = $c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1;
/** @constructor */
function $h_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype = $c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype;
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype.apply__O__O = (function(v1) {
  this.apply__Ljythonmusic_MidiTrack__V($as_Ljythonmusic_MidiTrack(v1))
});
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype.apply__Ljythonmusic_MidiTrack__V = (function(track) {
  var this$1 = $m_Ljythonmusic_MidiPlayer$().jythonmusic$MidiPlayer$$midiTracks$1;
  var channel = this$1.size0$6;
  $m_Ljythonmusic_MidiPlayer$().jythonmusic$MidiPlayer$$midiTracks$1.$$plus$eq__O__scm_ArrayBuffer(track);
  track.associated$undchannel$1 = channel;
  track.loadInstrumentAndCall__I__F0__V(channel, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      $m_Ljythonmusic_MidiPlayer$().jythonmusic$MidiPlayer$$trackLoaded$1__sr_IntRef__V(arg$outer.loadingCount$1$f)
    })
  })(this)))
});
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype.init___sr_IntRef = (function(loadingCount$1) {
  this.loadingCount$1$f = loadingCount$1;
  return this
});
var $d_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1 = new $TypeData().initClass({
  Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1: 0
}, false, "jythonmusic.MidiPlayer$$anonfun$loadAndPlayTracks$1", {
  Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1.prototype.$classData = $d_Ljythonmusic_MidiPlayer$$anonfun$loadAndPlayTracks$1;
/** @constructor */
...
/** @constructor */
function $c_Ljythonmusic_MidiTrack$Chord() {
  $c_Ljythonmusic_MidiTrack$NoteItem.call(this);
  this.notes$2 = null;
  this.velocity$2 = 0;
  this.duration$2 = 0.0
}
$c_Ljythonmusic_MidiTrack$Chord.prototype = new $h_Ljythonmusic_MidiTrack$NoteItem();
$c_Ljythonmusic_MidiTrack$Chord.prototype.constructor = $c_Ljythonmusic_MidiTrack$Chord;
/** @constructor */
function $h_Ljythonmusic_MidiTrack$Chord() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiTrack$Chord.prototype = $c_Ljythonmusic_MidiTrack$Chord.prototype;
$c_Ljythonmusic_MidiTrack$Chord.prototype.productPrefix__T = (function() {
  return "Chord"
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.productArity__I = (function() {
  return 3
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.init___sjs_js_Array__I__D = (function(notes, velocity, duration) {
  this.notes$2 = notes;
  this.velocity$2 = velocity;
  this.duration$2 = duration;
  return this
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ljythonmusic_MidiTrack$Chord(x$1)) {
    var Chord$1 = $as_Ljythonmusic_MidiTrack$Chord(x$1);
    return (($m_sr_BoxesRunTime$().equals__O__O__Z(this.notes$2, Chord$1.notes$2) && (this.velocity$2 === Chord$1.velocity$2)) && (this.duration$2 === Chord$1.duration$2))
  } else {
    return false
  }
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.notes$2;
      break
...
$c_Ljythonmusic_MidiTrack$Chord.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.notes$2));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.velocity$2);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.duration$2));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 3)
});
$c_Ljythonmusic_MidiTrack$Chord.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ljythonmusic_MidiTrack$Chord(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljythonmusic_MidiTrack$Chord)))
}
function $as_Ljythonmusic_MidiTrack$Chord(obj) {
  return (($is_Ljythonmusic_MidiTrack$Chord(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "jythonmusic.MidiTrack$Chord"))
}
function $isArrayOf_Ljythonmusic_MidiTrack$Chord(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljythonmusic_MidiTrack$Chord)))
}
function $asArrayOf_Ljythonmusic_MidiTrack$Chord(obj, depth) {
  return (($isArrayOf_Ljythonmusic_MidiTrack$Chord(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljythonmusic.MidiTrack$Chord;", depth))
}
var $d_Ljythonmusic_MidiTrack$Chord = new $TypeData().initClass({
  Ljythonmusic_MidiTrack$Chord: 0
}, false, "jythonmusic.MidiTrack$Chord", {
  Ljythonmusic_MidiTrack$Chord: 1,
  Ljythonmusic_MidiTrack$NoteItem: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Ljythonmusic_MidiTrack$Chord.prototype.$classData = $d_Ljythonmusic_MidiTrack$Chord;
/** @constructor */
function $c_Ljythonmusic_MidiTrack$Note() {
  $c_Ljythonmusic_MidiTrack$NoteItem.call(this);
  this.note$2 = 0;
  this.velocity$2 = 0;
  this.duration$2 = 0.0
}
$c_Ljythonmusic_MidiTrack$Note.prototype = new $h_Ljythonmusic_MidiTrack$NoteItem();
$c_Ljythonmusic_MidiTrack$Note.prototype.constructor = $c_Ljythonmusic_MidiTrack$Note;
/** @constructor */
function $h_Ljythonmusic_MidiTrack$Note() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiTrack$Note.prototype = $c_Ljythonmusic_MidiTrack$Note.prototype;
$c_Ljythonmusic_MidiTrack$Note.prototype.productPrefix__T = (function() {
  return "Note"
});
$c_Ljythonmusic_MidiTrack$Note.prototype.productArity__I = (function() {
  return 3
});
$c_Ljythonmusic_MidiTrack$Note.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ljythonmusic_MidiTrack$Note(x$1)) {
    var Note$1 = $as_Ljythonmusic_MidiTrack$Note(x$1);
    return (((this.note$2 === Note$1.note$2) && (this.velocity$2 === Note$1.velocity$2)) && (this.duration$2 === Note$1.duration$2))
  } else {
    return false
  }
});
$c_Ljythonmusic_MidiTrack$Note.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.note$2;
      break
...
$c_Ljythonmusic_MidiTrack$Note.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ljythonmusic_MidiTrack$Note.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.note$2);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.velocity$2);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.duration$2));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 3)
});
$c_Ljythonmusic_MidiTrack$Note.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Ljythonmusic_MidiTrack$Note.prototype.init___I__I__D = (function(note, velocity, duration) {
  this.note$2 = note;
  this.velocity$2 = velocity;
  this.duration$2 = duration;
  return this
});
function $is_Ljythonmusic_MidiTrack$Note(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljythonmusic_MidiTrack$Note)))
}
function $as_Ljythonmusic_MidiTrack$Note(obj) {
  return (($is_Ljythonmusic_MidiTrack$Note(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "jythonmusic.MidiTrack$Note"))
}
function $isArrayOf_Ljythonmusic_MidiTrack$Note(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljythonmusic_MidiTrack$Note)))
}
function $asArrayOf_Ljythonmusic_MidiTrack$Note(obj, depth) {
  return (($isArrayOf_Ljythonmusic_MidiTrack$Note(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljythonmusic.MidiTrack$Note;", depth))
}
var $d_Ljythonmusic_MidiTrack$Note = new $TypeData().initClass({
  Ljythonmusic_MidiTrack$Note: 0
}, false, "jythonmusic.MidiTrack$Note", {
  Ljythonmusic_MidiTrack$Note: 1,
  Ljythonmusic_MidiTrack$NoteItem: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ljythonmusic_MidiTrack$Note.prototype.$classData = $d_Ljythonmusic_MidiTrack$Note;
/** @constructor */
function $c_Ljythonmusic_MidiTrack$Rest() {
  $c_Ljythonmusic_MidiTrack$NoteItem.call(this);
  this.duration$2 = 0.0
}
$c_Ljythonmusic_MidiTrack$Rest.prototype = new $h_Ljythonmusic_MidiTrack$NoteItem();
$c_Ljythonmusic_MidiTrack$Rest.prototype.constructor = $c_Ljythonmusic_MidiTrack$Rest;
/** @constructor */
function $h_Ljythonmusic_MidiTrack$Rest() {
  /*<skip>*/
}
$h_Ljythonmusic_MidiTrack$Rest.prototype = $c_Ljythonmusic_MidiTrack$Rest.prototype;
$c_Ljythonmusic_MidiTrack$Rest.prototype.productPrefix__T = (function() {
  return "Rest"
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.productArity__I = (function() {
  return 1
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ljythonmusic_MidiTrack$Rest(x$1)) {
    var Rest$1 = $as_Ljythonmusic_MidiTrack$Rest(x$1);
    return (this.duration$2 === Rest$1.duration$2)
  } else {
    return false
  }
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.init___D = (function(duration) {
  this.duration$2 = duration;
  return this
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.duration$2;
      break
...
$c_Ljythonmusic_MidiTrack$Rest.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.duration$2));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 1)
});
$c_Ljythonmusic_MidiTrack$Rest.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ljythonmusic_MidiTrack$Rest(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljythonmusic_MidiTrack$Rest)))
}
function $as_Ljythonmusic_MidiTrack$Rest(obj) {
  return (($is_Ljythonmusic_MidiTrack$Rest(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "jythonmusic.MidiTrack$Rest"))
}
function $isArrayOf_Ljythonmusic_MidiTrack$Rest(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljythonmusic_MidiTrack$Rest)))
}
function $asArrayOf_Ljythonmusic_MidiTrack$Rest(obj, depth) {
  return (($isArrayOf_Ljythonmusic_MidiTrack$Rest(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljythonmusic.MidiTrack$Rest;", depth))
}
var $d_Ljythonmusic_MidiTrack$Rest = new $TypeData().initClass({
  Ljythonmusic_MidiTrack$Rest: 0
}, false, "jythonmusic.MidiTrack$Rest", {
  Ljythonmusic_MidiTrack$Rest: 1,
  Ljythonmusic_MidiTrack$NoteItem: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ljythonmusic_MidiTrack$Rest.prototype.$classData = $d_Ljythonmusic_MidiTrack$Rest;
/** @constructor */
function $c_s_None$() {
...
//# sourceMappingURL=jem-music-fastopt.js.map
